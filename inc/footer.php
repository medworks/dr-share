		...
		<div class="col12">
			<div class="col4">
				<div id="text-9" class="widget widget_text fade-in">		<div class="textwidget">
						...
						<p class="rtl">
							درباره کلینیک رهیاب... درباره کلینیک رهیاب... درباره کلینیک رهیاب... درباره کلینیک رهیاب... درباره کلینیک رهیاب... 
						</p>
					</div>
				</div>
 			</div>
 					...
 					<div class="menu-theme-links-footer-widget-container">
 						<ul id="menu-theme-links-footer-widget" class="menu">
 							<li id="menu-item-2768" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2768">
 								<a href="#" style="color:#ccc;">عنوان خبر</a>
 							</li>
							<li id="menu-item-2768" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2768">
 								<a href="#" style="color:#ccc;">عنوان خبر</a>
 							</li>
			...
			<div class="col2 last">	
        		<div id="contact-3" class="widget nt_contact_widget fade-in">
					...
					<span class="contact_widget_address">مشهد، خیابان احمد آباد، ابتدای خیابان عارف، جنب داروخانه دکتر شهسواری، ساختمان نگین، طبقه دوم، واحد3</span><br>
					<span class="contact_widget_phone">+44 12 345 6789</span><br>
					<span class="contact_widget_email"><a href="#" rel="moc/su//tcatnoc" class="email_link_replace">moc/su//tcatnoc</a></span><br>
        		</div>
        	</div>
...
<script type="text/javascript">
/* <![CDATA[ */
var wysijaAJAX = {"action":"wysija_ajax","controller":"subscribers","ajaxurl":"http:\/\/gazette.seoresearch.com\/wp-admin\/admin-ajax.php","loadingTrans":"Loading...","is_rtl":""};
var wysijaAJAX = {"action":"wysija_ajax","controller":"subscribers","ajaxurl":"http:\/\/gazette.seoresearch.com\/wp-admin\/admin-ajax.php","loadingTrans":"Loading...","is_rtl":""};
/* ]]> */
</script>
