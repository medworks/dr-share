                ...
                <div class="nt_form">
                    ...
                    <form id="frmclass" class="formdata" enctype="multipart/form-data" action="" method="post" role="form">
                        ...
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                            ...
                            <input type="text" id="edtbirth" name="edtbirth" class="textfield name" data-prompt-position="topLeft:-30" placeholder="1393" value="" />
                        </div>
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                            <label for="nt_field01">نام پدر
                                <span class="star"></span>
                            </label>
                            <input type="text" id="edtfather" name="edtfather" class="textfield name" data-prompt-position="topLeft:-20" value="" />
                        </div>
                        ...
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                            ...
                            <input type="text" id="edtmeli" name="edtmeli" class="textfield name" data-prompt-position="topLeft:-30" placeholder="0123456789" value="">
                        </div>
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                        ...
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                            ...
                            <input type="text" id="edtostan" name="edtostan" class="textfield name" data-prompt-position="topLeft:-30" value="">
                        </div>
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                        ...
                        <div class="nt_form_row name_row" style="margin-top:30px;">
                            ...
                            <textarea id="txtadd" name="txtadd" class="textarea" data-prompt-position="topLeft:550" rows="5" cols="40" style="height:100px"></textarea>
                        </div>
                        <div class="clearboth"></div>
                        <div class="nt_form_row name_row" style="margin-top:30px;display:inline-block">
                        ...
                        <div class="nt_form_row textarea_row">
                            ...
                            <textarea id="txtmsg" name="txtmsg" class="textarea" data-prompt-position="topLeft:600" rows="5" cols="40"></textarea>
                        </div>
